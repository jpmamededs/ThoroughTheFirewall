...
void Draw_Ranking(void)
{
    ...
    DrawRectangleRoundedLines(MENU_BOX_RECT, 0.25f, 6, menuLine);
    ...
    DrawRectangleRoundedLines(rankingBox, 0.03f, 8, NEON_GREEN);
    ...
    if (numRemaining < numToDraw) numToDraw = numRemaining;
    ...
    DrawRectangleRoundedLines(btnPrev, 0.25f, 6, NEON_GREEN);

    DrawRectangleRounded(btnNext, 0.25f, 6, nextHover ? NEON_GREEN_LT : BG_TRANS);
    DrawRectangleRoundedLines(btnNext, 0.25f, 6, NEON_GREEN);
